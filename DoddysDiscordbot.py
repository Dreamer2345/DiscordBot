...
async def on_member_join(member):
    ...
    fmt = 'Welcome {0.mention} to {1.name}! Please read the #rules and the #available-roles to properly understand the server! Thank you, please enjoy your stay!!!'
    await bot.send_message(x, content=fmt.format(member, server))
...
bot.run('MzYxNjg2NTE0MDE2NzE0NzUy.DKnuZg.gGtVPSzanyDRoX_fESmwCGdmqHw')
